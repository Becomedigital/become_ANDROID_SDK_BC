...
public class BecomeResponseManager {
    ...
    public void startAutentication(Activity activity) {
    ...
    private <T extends BaseActivityBecome> void startActivity(Class<MainBDIV> pClass) {
